...
// CODE HERE
newNumbers = numbers.map((element) => (element/2))
...
newCities = cities.filter(city => city[city.length - 1] === 'i')
...
*/ 
//indexOf() function locates the index
...
fruits.forEach((element) => {
  if (element.color === 'red'){
    ...
    console.log(`The fruit with index ${fruits.indexOf(element)} is neither an apple or orange`)
  }
})
...
// The fruit with index 0 is neither an apple or orange
// The fruit with index 1 is an orange
// The fruit with index 2 is neither an apple or orange
// The fruit with index 3 is an apple
...
// CODE HERE
const riceFoods = foods.filter(element => element.tags.includes("rice"))
const totalRice = riceFoods.reduce((RT, element) => RT + element.price, 0)
