...
// // CODE HERE
const totalPopulation  = populations.reduce((runningTotal, currentElement) => runningTotal + currentElement)
...
// // CODE HERE
const afterTax = orders.map(element => element.price +(element.price * element.tax))
...
const totalPrice = bobsTotal.reduce((runningTotal, currentElement) => runningTotal + currentElement.price, 0)
